...
#'}
#' @export
nnMetTraining <- function(group=c("sudo","docker"), scratch.folder, file,separator,nEpochs,patiencePercentage=5,projectName,bN="NULL",seed=111){
...
system(paste("cp ",bN," ",scrat_tmp.folder,"/",sep=""))
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d repbioinfo/neuralnetworkmet python3 /home/main.py ",matrixNameC,".",format," ",separator," ",nEpochs," ",patiencePercentage," ",projectName," ",bN," ",seed,sep="")

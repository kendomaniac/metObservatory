...
WARNING. Before to use the BW file generated from nnMetTraining is very important to check the training pdf generated. In this file is very important that the learning curve is not flat. If is so, regenerate the BW running again nnMetTraining. Seed value will be provided in order to generate the same weight given the same seed. 
